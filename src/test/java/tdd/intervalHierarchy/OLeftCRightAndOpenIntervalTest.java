...
public class OLeftCRightAndOpenIntervalTest extends IntervalTest {
	...
	protected List<Interval> createIntervals(
		...
		intervals.add(new IntervalBuilder().leftValue(leftValue).leftOpen().rightValue(rightValue).build());
		intervals.add(new OpenIntervalBuilder().leftValue(leftValueOther).rightValue(rightValueOther).build());
		return intervals;
	}
